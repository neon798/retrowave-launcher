...
object ColorTokens {
    ...
    @JvmField val ColorAccent = DayNightColorToken(SynthwaveOrangeLight, SynthwaveOrange)
    ...
    @JvmField val AllAppsTabBackgroundSelected = DayNightColorToken(SynthwavePinkLight, SynthwavePink)
    ...
    @JvmField val SearchboxHighlight = DayNightColorToken(SynthwavePurpleLight.setAlpha(0.3f), Neutral1_800)
    ...
    @JvmField val QsbIconTintPrimary = DayNightColorToken(SynthwaveBlueLight, SynthwaveBlue)

    @JvmField val QsbIconTintSecondary = DayNightColorToken(SynthwavePinkLight, SynthwavePink)

    @JvmField val QsbIconTintTertiary = DayNightColorToken(SynthwaveOrangeLight, SynthwaveOrange)

    @JvmField val QsbIconTintQuaternary = DayNightColorToken(SynthwavePinkLight, SynthwavePink)

    @JvmField val WallpaperPopupScrim = Neutral1_900

    @JvmField val WidgetsPickerScrim = Scrim.setAlpha(.32f)

    @JvmField val AccentRippleColor = DayNightColorToken(SynthwavePinkLight, SynthwavePink)

    @JvmField val WorkspaceAccentColor = DarkTextColorToken(SynthwaveOrangeLight, SynthwaveOrange)
    ...
    @JvmField val PrimaryButton = DayNightColorToken(SynthwaveOrangeLight, SynthwaveOrange)

    @JvmField val WidgetAddButtonBackgroundColor = PrimaryButton

    val SwitchThumbOn = SynthwaveOrange
    ...
    val SwitchTrackOn = DayNightColorToken(SynthwaveOrangeLight, SynthwaveOrange)
    ...
    @JvmField val ExpressiveAllApps = DayNightColorToken(SynthwavePurpleLight, SynthwavePurple).setAlpha(0.5f)
